  ...
  return (
    <div>
              ...
              <div className='flex-1 px-3 bg-white divide-y space-y-1'>
                <ul className='space-y-2 pb-2'>
                  ...
                  <li>
                    <a href='#' target='_blank' className='text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group '>
                      ...
                      <span className='ml-3 flex-1 whitespace-nowrap'>Herramientas</span>
                    </a>
                  </li>
                  <li>
                    <a href='#' target='_blank' className='text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group '>
                      ...
                      <span className='ml-3 flex-1 whitespace-nowrap'>Mensajes</span>
                    </a>
                  </li>
                  <li>
                    <a href='#' className='text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group '>
                      ...
                      <span className='ml-3 flex-1 whitespace-nowrap'>Usuarios activos</span>
                    </a>
                  </li>
                  <li>
                    <a href='#' className='text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group '>
                      <GiSlicedBread size={20} className='text-gray-500' />
                      <span className='ml-3 flex-1 whitespace-nowrap'>Productos</span>
                    </a>
                  </li>
                  <li className='lg:invisible'>
                    <a href='#' className='text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group '>
                      <RxExit className='text-gray-500' size={20} />
                      <span onClick={handleSignout} className='ml-3 flex-1 whitespace-nowrap'>Sign Out</span>
                    </a>
                  </li>
                </ul>
                <div className='space-y-2 pt-2'>
                  <a href='#' className='text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2'>
                    ...
                    <span className='ml-4'>Eventos exclusivos</span>
                  </a>
                  <a href='#' target='_blank' className='text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2'>
                    ...
                    <span className='ml-3'>Próximos eventos</span>
                  </a>
                  <a href='#' target='_blank' className='text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2'>
                    <svg className='w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
                      <path d='M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z' />
                    </svg>
                    <span className='ml-3'>Eventos asistidos</span>
                  </a>
                  <a href='#' target='_blank' className='text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2'>
                    <svg className='w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
                ...
                <div className='flex items-center justify-between mb-4'>
                  ...
                  <div className='flex items-center justify-end flex-1 text-green-500 text-base font-bold'>
                    ...
                    <svg className='w-5 h-5' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
                      <path d='M5.293 7.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L6.707 7.707a1 1 0 01-1.414 0z' clipRule='evenodd' />
                    </svg>
                  </div>
                </div>
                <div id='main-chart' />
              ...
              <div className='bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 '>
                <div className='flex items-center'>
                  ...
                  <div className='ml-5 w-0 flex items-center justify-end flex-1 text-red-500 text-base font-bold'>
                    -2.7%
                    <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
                      <path d='M14.707 12.293a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L9 14.586V3a1 1 0 012 0v11.586l2.293-2.293a1 1 0 011.414 0z' clipRule='evenodd' />
                    </svg>
                  </div>
                </div>
              </div>
      ...
      <div className='lg:mx-[400px]'>
        <footer className='m-4bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-2 my-6 mx-4'>
      ...
      <p className='text-center text-sm text-gray-500 my-10'>
        &copy; 2019-2021 <a href='#' className='hover:underline' target='_blank'>Dolce Veleno Bakery</a>. All rights reserved.
      </p>
      <Helmet>
